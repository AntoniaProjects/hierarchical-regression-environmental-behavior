...
- The final regression model explained 54% of the variance in pro-environmental behavior (R² = .54), indicating a substantial relationship between the included predictors and environmentally friendly behavior.
